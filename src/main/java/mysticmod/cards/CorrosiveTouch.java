...
public class CorrosiveTouch extends AbstractMysticCard {
    public static final String ID = "mysticmod:CorrosiveTouch";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (this.upgraded) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new SpellsPlayedNextTurn(p, 1), 1));
        }
    }

    @Override
    public AbstractCard makeCopy() {
        return new CorrosiveTouch();
    }
