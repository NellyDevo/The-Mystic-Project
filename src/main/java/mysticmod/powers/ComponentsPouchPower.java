...
public class ComponentsPouchPower extends AbstractPower implements SpellArteLogicAffector, CloneablePowerInterface {
    ...
    public ComponentsPouchPower(AbstractCreature owner, int amount) {
        ...
        ID = POWER_ID;
        this.owner = owner;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("mysticmod/images/powers/components pouch power 84.png"), 0, 0, 84, 84);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("mysticmod/images/powers/components pouch power 32.png"), 0, 0, 32, 32);
        type = PowerType.BUFF;
        this.amount = amount;
        updateDescription();
    }
    ...
    public AbstractPower makeCopy() {
        return new ComponentsPouchPower(owner, amount);
    }
}
