...
public class ArtesPlayedNextTurn extends AbstractPower {
    ...
    public ArtesPlayedNextTurn(AbstractCreature owner, int amount) {
        ...
        this.ID = POWER_ID;
        this.owner = owner;
        this.region128 = new TextureAtlas.AtlasRegion(new Texture("mysticmod/images/powers/artes played next turn 84.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(new Texture("mysticmod/images/powers/artes played next turn 32.png"), 0, 0, 32, 32);
