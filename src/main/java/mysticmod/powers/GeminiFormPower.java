...
public class GeminiFormPower extends AbstractPower {
    ...
    public GeminiFormPower(AbstractCreature owner, int amount) {
        ...
        this.ID = POWER_ID;
        this.owner = owner;
        this.region128 = new TextureAtlas.AtlasRegion(new Texture("mysticmod/images/powers/gemini form power 84.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(new Texture("mysticmod/images/powers/gemini form power 32.png"), 0, 0, 32, 32);
    ...
    public void onUseCard(AbstractCard c, UseCardAction action) {
        if (isActive) {
            if ((c instanceof AbstractMysticCard && ((AbstractMysticCard) c).isSpell() || c.hasTag(MysticTags.IS_SPELL))
            ...
            if ((c instanceof AbstractMysticCard && ((AbstractMysticCard) c).isArte() || c.hasTag(MysticTags.IS_ARTE))
