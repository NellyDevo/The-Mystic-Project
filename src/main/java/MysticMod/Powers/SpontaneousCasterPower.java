...
public class SpontaneousCasterPower extends AbstractPower {
    ...
    public void onInitialApplication() {
        ...
        for (final AbstractCard handCard : AbstractDungeon.player.hand.group) {
            ...
            if (!this.affectedCards.contains(handCard) && MysticMod.isThisASpell(handCard, false) && handCard.costForTurn != 0) {
    ...
    public void duringTurn() { //necessary?
        ...
        for (final AbstractCard handCard : AbstractDungeon.player.hand.group) {
            ...
            } else if (this.affectedCards.contains(handCard) && !MysticMod.isThisASpell(handCard, false)) {
