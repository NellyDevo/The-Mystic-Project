...
public class Spark
    ...
    public static final String DESCRIPTION = "Cantrip. NL Gain [E]. Draw a card. Exhaust.";
    public static final String UPGRADE_DESCRIPTION = "Cantrip. NL Gain [E]. Draw a card.";
