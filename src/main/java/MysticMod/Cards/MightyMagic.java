...
public class MightyMagic
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new com.megacrit.cardcrawl.actions.common.ApplyPowerAction(p, p, new MightyMagicPower(p, 1), 1));
    }

    @Override
    public AbstractCard makeCopy() {
        return new MightyMagic();
    }
